...
export default function Plizado() {
    ...
    const fetchData = () => {
        const apiUrl = `${API_BASE_URL}/procesos/pendientes-plizado`;
        setLoading(true);
    ...
    const handleSubmitSelected = () => {
        ...
        const endpoint = `${API_BASE_URL}/app/update-plizado`;
        axios.post(endpoint, { items: payload }, {
            ...
            .catch((error) => {
                ...
                alert('Error al subir elementos para Plizado.');
            });
    };
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ marginBottom: '20px', padding: '15px', border: '1px solid #ddd', borderRadius: '5px', backgroundColor: '#f9f9f9' }}>
                <h3 style={{ marginBottom: '15px', color: '#333' }}>Elementos Seleccionados - Plizado</h3>
