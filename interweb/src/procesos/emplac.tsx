...
export default function Emplacado() {
    ...
    const handleSubmitSelected = () => {
        ...
        const endpoint = `${API_BASE_URL}/app/update-emplacado`;
        axios.post(endpoint, { items: payload }, {
            ...
            .catch((error) => {
                ...
                alert('Error al subir elementos para Emplacado.');
            });
    };
        ...
        <div style={{ padding: '20px' }}>
            ...
            {selectedItems.length > 0 && (
                <div style={{ marginBottom: '20px', padding: '15px', border: '1px solid #ddd', borderRadius: '5px', backgroundColor: '#f9f9f9' }}>
                    <h3 style={{ marginBottom: '15px', color: '#333' }}>Elementos Seleccionados - Emplacado</h3>
